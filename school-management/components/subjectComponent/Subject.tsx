...
import type { Lesson, Subject, Teacher } from "@prisma/client";
...
const columns: columnsProps[] = [
  ...
  },
  {
    header: "Teachers",
    accessor: "teachers",
    classes: " table-cell font-bold text-md",
  },
  {
    header: "Actions",
    accessor: "action",
...
type subjectsDataProps = Subject & { teachers: Teacher[] } & {
  lessons: Lesson[];
};
...
const Subject = ({
  ...
  const renderRow = (item: subjectsDataProps) => (
    <TableRow
      key={item.id}
